...
from app.api.v1.endpoints import appointments, auth, care, health, health_library, journey, pathguide, village, voice
...
api_v1_router.include_router(village.router, prefix="/village", tags=["The Village"])
